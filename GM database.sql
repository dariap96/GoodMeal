...
-- Model Author: ---
-- object: test1 | type: ROLE --
-- DROP ROLE IF EXISTS test1;
CREATE ROLE test1 WITH ;
-- ddl-end --
...
-- ddl-end --
ALTER SCHEMA "GoodMeal" OWNER TO test1;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Ingridients" OWNER TO test1;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Recipes" OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Ingridients_Recipes" OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Selections" OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Users" OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Labels_Recipes" OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Dishes" OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Meals" OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Users_Roles" OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Cuisine" OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Roles" OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Health_Diet_Labels" OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Selection_Types" OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."HD_Label_Types" OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Ingridients_Selections" OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE "GoodMeal"."Recipes_Selections" OWNER TO postgres;
-- ddl-end --
